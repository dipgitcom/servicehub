...
<div class="servicehub-container">
    ...
    <div class="container py-4">
        <div class="row">
            <div class="col-md-12">
                <h1 class="section-title">ServiceHub Pay</h1>
            ...
            <div class="col-md-12">
                ...
                <div class="receipt-container" id="receiptContainer">
                    <div class="receipt-header">
                        <img src="{{ asset('images/servicehub-logo.png') }}" alt="ServiceHub" class="receipt-logo">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function processPayment() {
            ...
            setTimeout(function() {
                ...
                document.getElementById('transactionId').textContent = 'GP' + Math.floor(Math.random() * 10000000000);
                document.getElementById('transactionDate').textContent = new Date().toLocaleString();
                document.getElementById('paymentMethod').textContent = document.querySelector('.payment-method.active').querySelector('h6').textContent;
        ...
        // View booking button
        document.getElementById('viewBookingButton').addEventListener('click', function() {
